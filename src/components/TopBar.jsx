...
function TopBar({ isVisible, onCategorySelect, activeCategory }) {
	...
	return (
		<div
			className={`bg-purple-100 pt-24 py-6 absolute flex flex-row items-center justify-center top-0 left-0 w-[400px] flex-wrap z-[999] transition-transform duration-300 ${
